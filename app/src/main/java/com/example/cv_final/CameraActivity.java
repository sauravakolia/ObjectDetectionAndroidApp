...
//        cameraBridgeViewBase.setCvCameraViewListener(this);
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        String modelConfiguration = getAssetsFile("yolov3-tiny-prn.cfg", this);
        String modelWeights = getAssetsFile("yolov3-tiny-prn.weights", this);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        Mat blob = Dnn.blobFromImage(frame, 1.0 / 255.0, frame_size, mean,/*swapRB*/false, false);
        //save_mat(blob);
        net.setInput(blob);
